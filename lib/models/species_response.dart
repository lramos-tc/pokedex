...
SpeciesData speciesFromJson(String str) => SpeciesData.fromJson(json.decode(str));

String speciesToJson(SpeciesData data) => json.encode(data.toJson());
...
class SpeciesData {
    ...
    factory SpeciesData.fromJson(Map<String, dynamic> json) => SpeciesData(
